...
export default function Index() {
    ...
    return (
        ...
        getTransaction("")
                    ...
                    <button onClick={() =>{
        getTransaction("sent")
                        setTab("1")}} className={tab === "1" ? ' font-medium text-sm lg:text-lg text-[#0dadf7] ' : ' font-medium text-sm lg:text-lg '} > Sent</button>
                    <button onClick={() =>{ 
        getTransaction("receive")                
                        setTab("2")}} className={tab === "2" ? ' font-medium text-sm lg:text-lg text-[#0dadf7] ' : ' font-medium text-sm lg:text-lg '} > Received</button>
                </div>
            </div>
            {loading?
            <LoadingComponent /> :
