        ...
        <div className=' w-full flex flex-col rounded-[10px] pb-9 bg-white ' >
            ...
            <div className=' w-full flex items-center my-2 justify-center border lg:border-b lg:border-r-0 lg:border-t-0 lg:border-l-0 py-3 lg:px-4 border-[#D9D9D9] ' > 
                ...
                <div className=' ml-8 h-full lg:hidden flex flex-col items-center ' >
                    <button className=" w-[25px] h-[25px] rounded-full text-white bg-[#0dadf7] flex justify-center items-center text-2xl " >
            ...
            <div className=' w-full flex lg:flex-row flex-col lg:items-center justify-center border-b py-3 px-4 border-[#D9D9D9] ' >
                ...
                <p className=' font-normal text-lg lg:ml-14  ' >Amount <span className=' font-bold text-[#0dadf7] ' >300,000</span></p>
            </div>
            <div className=' w-[300px] mx-auto  ' > 
                ...
                <div className=' flex justify-between my-2 items-center ' >
                    ...
                    <button className=' w-[12px] h-[12px] rounded-full bg-[#0dadf7] border-[1.5px] border-[#0dadf7] ' >
                ...
                <div className=" mt-6 lg:flex-row flex-col flex items-center " >
                    <button className=' w-full lg:mr-2 text-sm rounded-[4px] text-white bg-[#0dadf7] h-[40px] ' >Pay N8,333.33</button>
                    <button className=' w-full lg:ml-2 text-sm lg:mt-0 mt-4 rounded-[4px] text-[#0dadf7] border border-[#0dadf7] font-semibold h-[40px] ' >Custome Pay</button>
                </div>
            </div>
        </div>
    )
