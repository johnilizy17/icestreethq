    ...
    return (
        <nav className=' lg:loginShadow w-full flex px-[11px] lg:px-[35px] h-[70px] lg:h-[89px] justify-between items-center ' >
            <Box className=' flex items-center ' >
                ...
                <Center ml="-20px"  display={["flex","flex","flex", "none"]} h={["50px"]} w={["170px", "170px", "170px", "250px"]} onClick={() => Router.push("/")} className={menu ? ' hidden lg:flex items-center ' : ' flex items-center '} >
