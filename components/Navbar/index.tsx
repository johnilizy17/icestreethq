                ...
                <Box style={{ boxShadow: "0px -1px 1px 0px #00000033" }} className=' text-xs lg:hidden text-[#434343] font-medium w-full bg-white left-0 right-0 px-[14px] flex justify-between items-center fixed bottom-0 h-[55px] ' >
                    ...
                    <button
                        ...
                        <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M35.5 35L25.5 25M5.5 16.6667C5.5 18.1988 5.80177 19.7158 6.38807 21.1313C6.97438 22.5468 7.83374 23.8329 8.91709 24.9162C10.0004 25.9996 11.2866 26.859 12.702 27.4453C14.1175 28.0316 15.6346 28.3333 17.1667 28.3333C18.6988 28.3333 20.2158 28.0316 21.6313 27.4453C23.0468 26.859 24.3329 25.9996 25.4162 24.9162C26.4996 23.8329 27.359 22.5468 27.9453 21.1313C28.5316 19.7158 28.8333 18.1988 28.8333 16.6667C28.8333 15.1346 28.5316 13.6175 27.9453 12.202C27.359 10.7866 26.4996 9.50044 25.4162 8.41709C24.3329 7.33374 23.0468 6.47438 21.6313 5.88807C20.2158 5.30177 18.6988 5 17.1667 5C15.6346 5 14.1175 5.30177 12.702 5.88807C11.2866 6.47438 10.0004 7.33374 8.91709 8.41709C7.83374 9.50044 6.97438 10.7866 6.38807 12.202C5.80177 13.6175 5.5 15.1346 5.5 16.6667Z" stroke={router.pathname === "/search" ? "#0dadf7" : "#434343"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
