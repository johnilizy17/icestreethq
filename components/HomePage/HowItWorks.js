      ...
      <motion.div ref={ref} initial="hidden" animate={control} transform="skew(50deg)"
        ...
        <SimpleGrid pos="relative" columns={[1, 1, 2, 2]} spacing={10}>
          <Box bg="#021E2A" pos="relative" border="1px solid rgba(87, 208, 239, 1)" borderRadius='18px' p={7}>
            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="#3030EC" class="bi bi-building" viewBox="0 0 16 16">
          ...
          <Box bg="#021E2A" pos="relative" border="1px solid rgba(87, 208, 239, 1)" borderRadius='18px' p={7} >
            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="#3030EC" class="bi bi-megaphone-fill" viewBox="0 0 16 16">
