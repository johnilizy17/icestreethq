...
export default function Subscription() {
    ...
    return (
        <>
            ...
            <Center mt="30px" w="full" flexDir={["column", "column", "column", "row"]} alignItems={"self-start"}  >
                <Center w="full" flexDir="column">
                    ...
                    <Box w={["100%", "100%", "100%", "350px"]} textAlign="center" p={["16px", "16px", "16px", "12px"]}>
                     United Kingdom & Nigeria Only!!
                     </Box>
                </Center>
                <Center mt={["30px", "30px", "30px", "0px"]} justifyContent="center" w="full" flexDir="column">
                ...
                <Center w="full" mt={["30px", "30px", "30px", "0px"]} flexDir="column">
                    ...
                    <Box w={["100%", "100%", "100%", "350px"]} textAlign="center" p={["16px", "16px", "16px", "12px"]}>
                        {"Dedit/credit card, Paypal and Paystack"}
                    </Box>
                </Center>
            </Center>
        </>
